...
var _src_webdriver_network_BrowserNetworkInterceptor = {};
var _src_webdriver_network_BrowserNetworkMonitor = {};
var _src_webdriver_network_CDPConnection = {};
...
class IQuery extends atma_utils_1.class_Dfr {
    ...
    require(opts) {
        ...
        (0, async_1.async_toThenable)(this).then((ctx) => {
...
async function buildDriver(config) {
...
async function waitForTrue(check, mix) {
    ...
    async function tick() {
        ...
        await _promise_1.$promise.wait(nextTickMs);
        await tick();
    }
    await tick();
}
...
class CherrioQuery extends IQuery_1.IQuery {
    ...
    hasClassFn(node, name) {
        return (0, dfr_1.dfr_resolve)(cheerio(node).hasClass(name));
    }
    addClassFn(node, name) {
    ...
    textGetFn(node) {
        ...
        return (0, dfr_1.dfr_resolve)(cheerio(node)[method]());
    }
    textSetFn(node, text) {
    ...
    htmlOuterGetFn(node) {
        return (0, dfr_1.dfr_resolve)(cheerio.html(node));
    }
    htmlGetFn(node) {
    ...
    cssGet(node, prop) {
        return (0, dfr_1.dfr_resolve)(cheerio(node).css(prop));
    }
    cssSet(node, css) {
    ...
    //#region Properties
    attrGetFn(node, prop) {
        return (0, dfr_1.dfr_resolve)(cheerio(node).attr(prop));
    }
    attrSetFn(node, attr) {
        for (let key in attr) {
    ...
    valGetFn(node) {
        return (0, dfr_1.dfr_resolve)(cheerio(node).val());
    }
    valSetFn(node, value) {
    ...
    dataGetFn(node, key) {
        return (0, dfr_1.dfr_resolve)(cheerio(node).data(key));
    }
    dataSetFn(node, data) {
        for (let key in data) {
    ...
    propGetFn(node, key) {
        return (0, dfr_1.dfr_resolve)(cheerio(node).prop(key));
    }
    propSetFn(node, data) {
        for (let key in data) {
    ...
    matchesFn(node, selector) {
        return (0, dfr_1.dfr_resolve)(cheerio(node).is(selector));
    }
    parentFn(node) {
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_webdriver_network_BrowserNetworkInterceptor != null ? _src_webdriver_network_BrowserNetworkInterceptor : {};
    var module = { exports: exports };

    "use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.BrowserNetworkInterceptor = void 0;
class BrowserNetworkInterceptor {
    constructor(wsConnection, devToolsConnection) {
...
exports.BrowserNetworkInterceptor = BrowserNetworkInterceptor;
//# sourceMappingURL=BrowserNetworkInterceptor.js.map
//# sourceMappingURL=BrowserNetworkInterceptor.ts.map;

    function __isObj(x) {
        return x != null && typeof x === 'object' && x.constructor === Object;
    }
    if (_src_webdriver_network_BrowserNetworkInterceptor === module.exports) {
        // do nothing if
    } else if (__isObj(_src_webdriver_network_BrowserNetworkInterceptor) && __isObj(module.exports)) {
        Object.assign(_src_webdriver_network_BrowserNetworkInterceptor, module.exports);
    } else {
        _src_webdriver_network_BrowserNetworkInterceptor = module.exports;
    }
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_webdriver_network_CDPConnection != null ? _src_webdriver_network_CDPConnection : {};
    var module = { exports: exports };
...
let ID = 0;
class CDPConnection {
    constructor(wsConnection, sessionId) {
        this.wsConnection = wsConnection;
    ...
    execute(method, params, onMessageSent = null) {
        let message = {
...
//# sourceMappingURL=CDPConnection.ts.map;

    function __isObj(x) {
        return x != null && typeof x === 'object' && x.constructor === Object;
    }
    if (_src_webdriver_network_CDPConnection === module.exports) {
        // do nothing if
    } else if (__isObj(_src_webdriver_network_CDPConnection) && __isObj(module.exports)) {
        Object.assign(_src_webdriver_network_CDPConnection, module.exports);
    } else {
        _src_webdriver_network_CDPConnection = module.exports;
    }
...
(function () {
    // ensure AMD is not active for the model, so that any UMD exports as commonjs
    var define = null;
    var exports = _src_webdriver_network_BrowserNetworkMonitor != null ? _src_webdriver_network_BrowserNetworkMonitor : {};
    var module = { exports: exports };

    "use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.BrowserNetworkMonitor = void 0;
const atma_utils_1 = require("atma-utils");
const CDPConnection_1 = _src_webdriver_network_CDPConnection;
class BrowserNetworkMonitor extends atma_utils_1.class_EventEmitter {
    constructor(driver, wsConnection) {
        super();
        this.driver = driver;
        this.wsConnection = wsConnection;
        this.cdp = new CDPConnection_1.CDPConnection(this.wsConnection, this.driver.sessionId);
        this.requests = [];
        this.requestsHash = {};
        wsConnection.on('message', message => {
            this.onMessage(JSON.parse(message));
...
exports.BrowserNetworkMonitor = BrowserNetworkMonitor;
//# sourceMappingURL=BrowserNetworkMonitor.js.map
//# sourceMappingURL=BrowserNetworkMonitor.ts.map;

    function __isObj(x) {
        return x != null && typeof x === 'object' && x.constructor === Object;
    }
    if (_src_webdriver_network_BrowserNetworkMonitor === module.exports) {
        // do nothing if
    } else if (__isObj(_src_webdriver_network_BrowserNetworkMonitor) && __isObj(module.exports)) {
        Object.assign(_src_webdriver_network_BrowserNetworkMonitor, module.exports);
    } else {
        _src_webdriver_network_BrowserNetworkMonitor = module.exports;
    }
...
const CookieContainer_1 = _src_common_CookieContainer;
const BrowserNetworkInterceptor_1 = _src_webdriver_network_BrowserNetworkInterceptor;
const BrowserNetworkMonitor_1 = _src_webdriver_network_BrowserNetworkMonitor;
...
SQuery.BrowserNetworkInterceptor = BrowserNetworkInterceptor_1.BrowserNetworkInterceptor;
SQuery.BrowserNetworkMonitor = BrowserNetworkMonitor_1.BrowserNetworkMonitor;
