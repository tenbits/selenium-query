        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, singleton.ensureCookies(url, this.cookies, config)];
                    case 2:
                        _a.sent();
...
var SQueryBase = /** @class */ (function () {
    ...
    //#endregion
    //#region driver utils
    SQueryBase.prototype.unlock = function () {
        build_1.BuildStatics.unlockDriver(this);
    };
    ...
    SQueryBase.fetch = function (url, config, setts) {
        return build_1.BuildStatics.fetch(url, config, setts);
    };
    SQueryBase.setDriver = function (driver) {
        DriverPool_1.driverPool.setGlobal(driver);
    };
    SQueryBase.getDriver = function (config, setts) {
        return DriverPool_1.driverPool.get('', config, setts);
    };
    SQueryBase.unlockDriver = function (mix) {
        build_1.BuildStatics.unlockDriver(mix);
    };
    return SQueryBase;
}());
