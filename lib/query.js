    ...
    fetch(url, config, setts) {
        ...
        DriverPool_1.driverPool
            ...
            wrapper
                ...
                if ('findElements' in result || ((0, atma_utils_1.is_ArrayLike)(result) && result.length !== 0 && 'findElements' in result[0])) {
...
class WebdriverQuery extends IQuery_1.IQuery {
    ...
    cssSet(node, css) {
        return (0, node_1.node_eval)(node, scripts_nodeCss, css);
    }
    async heightGetFn(node) {
        return (await this.getBoundingClientRect(node)).height;
    }
    ...
    dataGetFn(node, key) {
        return (0, node_1.node_eval)(node, scripts_nodeDataset, key);
    }
    dataSetFn(node, data) {
        return (0, node_1.node_eval)(node, scripts_nodeDataset, data);
    }
    propGetFn(node, key) {
        return (0, node_1.node_eval)(node, scripts_nodeProperty, key);
    }
    propSetFn(node, data) {
        return (0, node_1.node_eval)(node, scripts_nodeProperty, data);
    }
    //#endregion
    findFn(node, selector) {
        return new Promise((resolve, reject) => {
    ...
    getField(node, field) {
        return (0, node_1.node_eval)(node, scripts_nodeProperty, field);
    }
    setField(node, mix, val) {
        if (arguments.length === 2) {
            return (0, node_1.node_eval)(node, scripts_nodeProperty, mix);
        }
        if (arguments.length === 3) {
            return (0, node_1.node_eval)(node, scripts_nodeProperty, mix, val);
        }
        return null;
    }
    callField(node, field, ...args) {
