            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.singleton == null)) return [3 /*break*/, 2];
                        this.singleton = new DriverWrapper();
                        return [4 /*yield*/, this.singleton.build(config)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.singleton.ensureCookies(url, this.cookies, config)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/, this.singleton];
                }
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        if (!(this.pool.length < COUNT)) return [3 /*break*/, 5];
                        wrapper = new DriverWrapper();
...
exports.BuildStatics = {
    ...
    fetch: function (url, opts, config, setts) {
        ...
        DriverPool_1.driverPool
            ...
            wrapper
                ...
                if (setts && Boolean(setts.pool)) {
                    DriverPool_1.driverPool.releaseDriver(wrapper.driver);
                }
                var error = result && result.name === 'Error';
                if (error) {
                    dfr.reject(error);
                    return;
                }
                if ('findElements' in result) {
                    dfr.resolve(new SQuery_1.SQueryBase(result));
                    return;
                }
                dfr.resolve(result);
...
var SQueryBase = /** @class */ (function () {
    ...
    //#endregion
    SQueryBase.build = function (config, setts) {
        return build_1.BuildStatics.build(config, setts);
    };
    SQueryBase.load = function (url, config, setts) {
        return build_1.BuildStatics.load(url, config, setts);
    };
    SQueryBase.fetch = function (url, opts, config, setts) {
        return build_1.BuildStatics.fetch(url, opts, config, setts);
    };
    ...
    SQueryBase.releaseDriver = function (mix) {
        build_1.BuildStatics.releaseDriver(mix);
    };
    return SQueryBase;
}());
