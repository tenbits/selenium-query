...
var IQuery = /** @class */ (function (_super) {
    ...
    IQuery.prototype.filter = function (mix) {
        ...
        if (typeof mix === 'string') {
            var selector_1 = mix;
            return async_1.async_filter(this, function (node) { return _this.matchesFn(node, selector_1); });
        }
        var fn = mix;
...
var CookieContainer = /** @class */ (function () {
    ...
    CookieContainer.prototype.addCookies = function (url, cookies) {
        var domain = 'global';
...
function waitForElement(query, selector) {
    ...
    waitForTrue(function () {
        return query.find(selector).then(function (x) { return x.length !== 0; });
    }, 10000).then(function () {
...
var SQuery = /** @class */function (_super) {
	...
	SQuery = __decorate([classify_1.Classify, classify_1.FnPrototypeAlias], SQuery);
	return SQuery;
