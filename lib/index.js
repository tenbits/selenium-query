...
var SQueryClass_1 = _src_SQueryClass;
function async_each(self, fn) {
    var $ = new SQueryClass_1.SQuery();
    ...
    return async_next(self, function ($, source) {
        return async_waterfall(source, function (node, i) {
            return dfr_1.dfr_run(function (resolve) {
                ...
                x.then(add, function () { return add(null); });
            });
        });
    });
}
...
exports.BuildStatics = {
    ...
    load: function (url, config) {
        ...
        var query = new SQueryClass_1.SQuery();
        driver
            .get(url)
            .then(function () {
            query.add(driver);
...
var SQuery = /** @class */ (function (_super) {
    ...
    SQuery.prototype.slice = function (start, end) {
    ...
    SQuery.prototype.map = function (fn) {
        return async_1.async_map(this, fn);
    };
    SQuery.prototype.toArray = function () {
        var _this = this;
        return dfr_1.dfr_run(function (resolve) {
            _this.done(function ($) {
    ...
    SQuery.prototype.text = function (str) {
    ...
    SQuery.prototype.before = function (html) {
        return Content.inserter(this, html, 'beforebegin');
    };
    SQuery.prototype.after = function (html) {
        return Content.inserter(this, html, 'afterend');
    };
    SQuery.prototype.css = function (mix, val) {
    ...
    SQuery.prototype.height = function (val) {
        if (val == null) {
            return async_1.async_getValueOf(0, this, function (node) {
    ...
    SQuery.prototype.innerHeight = function () {
        return async_1.async_getValueOf(0, this, function (node) {
            return node_1.node_eval(node, scripts_nodeProperty, 'offsetHeight');
        });
    };
    SQuery.prototype.width = function (val) {
    ...
    SQuery.prototype.scrollTop = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    SQuery.prototype.scrollLeft = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    //#endregion
    //#region driver
    SQuery.prototype.eval = function (mix) {
        var args = [];
    ...
    //#endregion
    //#region Events
    SQuery.prototype.click = function () {
        return async_1.async_each(this, function ($, node) {
    ...
    SQuery.prototype.trigger = function (type) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
    ...
    SQuery.prototype.select = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
    ...
    SQuery.prototype.focus = function () {
        return Events.callFn(this, 'focus');
    };
    SQuery.prototype.blur = function () {
        return Events.callFn(this, 'blur');
    };
    SQuery.prototype.sendKeys = function (mix) {
        return async_1.async_each(this, function ($, node) {
    ...
    SQuery.prototype.type = function (str) {
    ...
    SQuery.prototype.press = function (str) {
    ...
    //#endregion
    //#region Properties
    SQuery.prototype.attr = function (mix, val) {
        if (val === void 0) { val = null; }
        if (arguments.length === 1 && typeof mix === 'string') {
            return async_1.async_getValueOf(0, this, function (node) {
    ...
    SQuery.prototype.val = function (val) {
        if (val === void 0) { val = null; }
    ...
    SQuery.prototype.data = function (key, val) {
        if (val === void 0) { val = null; }
    ...
    SQuery.prototype.prop = function (key, val) {
        if (val === void 0) { val = null; }
        if (arguments.length === 1) {
            return async_1.async_getValueOf(0, this, function (node) {
...
;
	...
	if (isObject(_src_SQueryClass) && isObject(module.exports)) {
		Object.assign(_src_SQueryClass, module.exports);
		return;
	}
	_src_SQueryClass = module.exports;
}());
// end:source ./ModuleSimplified.js
...
"use strict";
var SQueryClass_1 = _src_SQueryClass;
module.exports = SQueryClass_1.SQuery;
